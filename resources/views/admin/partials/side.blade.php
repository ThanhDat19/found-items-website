        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="/admin/categories/add">Thêm loại bài đăng</a>
                        </li>
                        <li class="submenu-item">
                            <a href="/admin/categories/list">Danh sách loại bài đăng</a>
                        </li>
                    </ul>
                </li>
                {{-- POST --}}
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="/admin/posts/add">Thêm bài đăng</a>
                        </li>
                        <li class="submenu-item">
                            <a href="/admin/posts/list">Danh sách bài đăng</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="/admin/accounts/users/list">Danh sách thành viên</a>
                        </li>
                        <li class="submenu-item">
                            <a href="/admin/accounts/admins/list">Danh sách Admin</a>
                        </li>
                    </ul>
                </li>
